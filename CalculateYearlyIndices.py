...
class CalculateYearlyIndices:
    ...
    def run_pipeline(self):
        ...
        job.get_results().download_file("ndvi-results/ndvi-morocco.csv")
        ...
        #timeseries = self.ndvi.aggregate_spatial(geometries=fields, reducer="mean")
        job.get_results().download_file("ndvi-results/ndwi-morocco.csv")

CalculateYearlyIndices().run_pipeline()
